 ...
 */
import { bestSellers as api_analytics_best_sellers_bestSellers } from "~backend/analytics/best_sellers";
import { categoryPerformance as api_analytics_category_performance_categoryPerformance } from "~backend/analytics/category_performance";
import { dashboardMetrics as api_analytics_dashboard_metrics_dashboardMetrics } from "~backend/analytics/dashboard_metrics";
import { salesTrends as api_analytics_sales_trends_salesTrends } from "~backend/analytics/sales_trends";
...
export namespace analytics {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.categoryPerformance = this.categoryPerformance.bind(this)
            this.dashboardMetrics = this.dashboardMetrics.bind(this)
            this.salesTrends = this.salesTrends.bind(this)
        }

        /**
         * Returns the top 10 best-selling products.
         */
        public async bestSellers(): Promise<ResponseType<typeof api_analytics_best_sellers_bestSellers>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/best-sellers`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_best_sellers_bestSellers>
        }

        /**
         * Returns performance metrics by product category.
         */
        public async categoryPerformance(): Promise<ResponseType<typeof api_analytics_category_performance_categoryPerformance>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/category-performance`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_category_performance_categoryPerformance>
        }

        /**
         * Returns key metrics for the admin dashboard.
         */
        public async dashboardMetrics(): Promise<ResponseType<typeof api_analytics_dashboard_metrics_dashboardMetrics>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/dashboard`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_dashboard_metrics_dashboardMetrics>
        }

        /**
         * Returns sales trends over the specified number of days.
         */
        public async salesTrends(params: RequestType<typeof api_analytics_sales_trends_salesTrends>): Promise<ResponseType<typeof api_analytics_sales_trends_salesTrends>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/sales-trends`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_sales_trends_salesTrends>
        }
    }
}
...
export namespace cart {
    ...
    export class ServiceClient {
        ...
        public async clear(): Promise<void> {
            await this.baseClient.callTypedAPI(`/cart/clear`, {method: "DELETE", body: undefined})
        }
        ...
        public async update(params: RequestType<typeof api_cart_update_update>): Promise<ResponseType<typeof api_cart_update_update>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/cart/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
...
export namespace order {
    ...
    export class ServiceClient {
        ...
        public async get(params: { id: number }): Promise<ResponseType<typeof api_order_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/orders/${encodeURIComponent(params.id)}/details`, {method: "GET", body: undefined})
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { categories as api_product_categories_categories } from "~backend/product/categories";
...
export namespace product {
    ...
    export class ServiceClient {
         ...
         */
        public async categories(): Promise<ResponseType<typeof api_product_categories_categories>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/products/categories`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_product_categories_categories>
        }
