...
```bash
git remote add encore encore://fastapi-ecommerce-backend-gtm2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/fastapi-ecommerce-backend-gtm2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/fastapi-ecommerce-backend-gtm2/settings/integrations/github)
